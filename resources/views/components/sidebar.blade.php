    ...
    <div class="flex-grow px-3 py-4 bg-gray-50 dark:bg-gray-800">
        ...
        <ul class="space-y-2 font-medium flex-grow">
            ...
            <li>
                ...
                id="kependudukan-dropdown-toggle">
                    <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                        <path d="M14 2a3.963 3.963 0 0 0-1.4.267 6.439 6.439 0 0 1-1.331 6.638A4 4 0 1 0 14 2Zm1 9h-1.264A6.957 6.957 0 0 1 15 15v2a2.97 2.97 0 0 1-.184 1H19a1 1 0 0 0 1-1v-1a5.006 5.006 0 0 0-5-5ZM6.5 9a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9ZM8 10H5a5.006 5.006 0 0 0-5 5v2a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1v-2a5.006 5.006 0 0 0-5-5Z"/>
                    </svg>
                    <span class="sidebar-text w-full flex-1 ms-3 whitespace-nowrap transition-all duration-300 ease-in-out">Kependudukan</span>
                    <svg class="w-3 h-3 ml-auto ms-14 transition-transform duration-300 group-hover:rotate-180" id="kependudukan-icon"
                ...
                <ul id="kependudukan-dropdown" class="hidden overflow-hidden space-y-2 ml-6 transition-[max-height] duration-300 ease-in-out">
                    ...
                    <li>
                        <a href="/kependudukan/mutasi" class="flex items-center px-4 py-2 text-gray-700 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg">
                            <i class="fa-solid fa-arrows-left-right text-gray-500 mr-3"></i>
                            Mutasi Penduduk
                        </a>
                    </li>
                </ul>
            ...
            <li>
                <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="sidebar-text flex-1 ms-3 whitespace-nowrap transition-all duration-300 ease-in-out">Keuangan</span>
            ...
            <li>
                <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="sidebar-text flex-1 ms-3 whitespace-nowrap transition-all duration-300 ease-in-out">Administrasi</span>
                </a>
            </li>
            <li>
                <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="sidebar-text flex-1 ms-3 whitespace-nowrap transition-all duration-300 ease-in-out">Pengumuman</span>
                </a>
            </li>
            <li>
                <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="sidebar-text flex-1 ms-3 whitespace-nowrap transition-all duration-300 ease-in-out">Laporan</span>
                </a>
            </li>
        </ul>
    </div>
